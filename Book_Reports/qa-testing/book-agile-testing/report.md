# Study Report: Agile Testing — QA & Test Engineer

*Written by Gagan Pasupuleti*
*Book study report | Agile Testing by Lisa Crispin & Janet Gregory*

## Summary

Study report for *Agile Testing* by Lisa Crispin & Janet Gregory (Intermediate level) mapped to the QA & Test Engineer role. Testing in Scrum: whole-team quality and automation strategy.
...
#### Chapter 1: About Agile Testing *(Level: Intermediate)*

**Chapter focus: About Agile Testing** *(Level: Intermediate)*

This study report summarizes *Agile Testing* by Lisa Crispin & Janet Gregory for the QA & Test Engineer role. The resource is rated Intermediate level. Testing in Scrum: whole-team quality and automation strategy. Use this report alongside the official material to prepare for CodeQuest review.
...
### What it actually is
A structured study report based on Agile Testing.
...
QA & Test Engineer professionals use ideas from Agile Testing to solve real workplace problems. Testing in Scrum: whole-team quality and automation strategy. This chapter explains how the book fits into your learning path and what you should be able to do after studying it.

Code Reference:
```text
Role: QA & Test Engineer
Book focus: Testing in Scrum: whole-team quality and automation strategy.
...
The main topics in Agile Testing include practical concepts described as: Testing in Scrum: whole-team quality and automation strategy. Study each topic with hands-on practice. Take notes on definitions, workflows, and examples that match tools used in QA & Test Engineer jobs today.
...
Finish Agile Testing with a weekly plan: read one section, write a summary, complete one exercise, and reflect on how it applies to QA & Test Engineer. If a free edition exists, practice every example. Submit your notes and one mini-project demo for teacher review.
...
- https://agiletester.ca/agile-testing-book/