# Study Report: Naked Statistics — Data Analyst

*Written by Gagan Pasupuleti*
*Book study report | Naked Statistics by Charles Wheelan*

## Summary

Study report for *Naked Statistics* by Charles Wheelan (Beginner level) mapped to the Data Analyst role. Statistics explained without heavy math — perfect for analysts.
...
#### Chapter 1: About Naked Statistics *(Level: Beginner)*

**Chapter focus: About Naked Statistics** *(Level: Beginner)*

This study report summarizes *Naked Statistics* by Charles Wheelan for the Data Analyst role. The resource is rated Beginner level. Statistics explained without heavy math — perfect for analysts. Use this report alongside the official material to prepare for CodeQuest review.
...
### What it actually is
A structured study report based on Naked Statistics.
...
Data Analyst professionals use ideas from Naked Statistics to solve real workplace problems. Statistics explained without heavy math — perfect for analysts. This chapter explains how the book fits into your learning path and what you should be able to do after studying it.

Code Reference:
```text
Role: Data Analyst
Book focus: Statistics explained without heavy math — perfect for analysts.
...
The main topics in Naked Statistics include practical concepts described as: Statistics explained without heavy math — perfect for analysts. Study each topic with hands-on practice. Take notes on definitions, workflows, and examples that match tools used in Data Analyst jobs today.
...
Finish Naked Statistics with a weekly plan: read one section, write a summary, complete one exercise, and reflect on how it applies to Data Analyst. If a free edition exists, practice every example. Submit your notes and one mini-project demo for teacher review.
...
- https://charleswheelan.com/naked-statistics/