...

  {
    ...
    months: [
      sharedMonth1,
      {
        month: 2,
        title: 'Web APIs',
        theme: 'FastAPI, HTTP, and REST design',
        weeks: [
          { week: 1, topic: 'HTTP & REST Principles', activities: ['Methods, status codes', 'CRUD design', 'Postman'] },
          { week: 2, topic: 'FastAPI Basics', activities: ['Routes & schemas', 'Pydantic models', 'Auto-docs'] },
          { week: 3, topic: 'Database Integration', activities: ['SQLAlchemy ORM', 'Migrations', 'PostgreSQL setup'] },
          { week: 4, topic: 'Auth & Security', activities: ['JWT tokens', 'Password hashing', 'Role guards'] },
        ],
        capstone: 'Build a REST API with auth, CRUD endpoints, and Postgres',
      },
      {
        month: 3,
        title: 'Production Readiness',
        theme: 'Testing, Docker, CI/CD',
        weeks: [
          { week: 1, topic: 'Testing', activities: ['pytest', 'Unit vs integration', 'Mocking'] },
          { week: 2, topic: 'Containerisation', activities: ['Docker basics', 'docker-compose', 'Multi-stage builds'] },
          { week: 3, topic: 'CI/CD', activities: ['GitHub Actions pipeline', 'Lint & test gates', 'Auto-deploy'] },
          { week: 4, topic: 'Performance & Caching', activities: ['Profiling', 'Redis caching', 'Background tasks'] },
        ],
        capstone: 'Containerise and deploy an API with a full CI pipeline',
      },
      {
        month: 4,
        title: 'System Design & Career',
        theme: 'Scalability patterns and job readiness',
        weeks: [
          { week: 1, topic: 'System Design Basics', activities: ['Load balancers', 'DB scaling', 'Message queues'] },
          { week: 2, topic: 'Advanced Patterns', activities: ['Event-driven', 'Microservices intro', 'API gateway'] },
          { week: 3, topic: 'Portfolio & Resume', activities: ['GitHub projects', 'Technical blog', 'Open-source contrib'] },
          { week: 4, topic: 'Mock Interviews', activities: ['Coding rounds', 'System design mock', 'HR prep'] },
        ],
        capstone: 'Capstone: production-grade API with docs, tests, and deploy',
      },
    ],
  },
