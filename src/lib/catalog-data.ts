...
export const CATALOG_PROJECTS: CatalogProject[] = [
  ...
  },
  {
    ...
    shortDescription: 'Create an ATS-friendly resume generator with Python and JSON output.',
    ...
    steps: [
      {
        ...
        content: {
          ...
          points: [
            ...
            'Add a simple quality/ATS check',
            'Keep the flow easy for beginners',
          ],
        },
      },
      {
        ...
        content: {
          ...
          points: [
            'Create a base profile dictionary',
            'Normalize and deduplicate skills',
            'Append experience entries safely',
            'Generate markdown/plain text output',
            'Compute ATS score from required skills match',
          ],
        },
      },
      {
      ...
      },
      {
        ...
        type: 'preview',
        content: {
          description: 'Run your script and inspect the structured resume object and ATS score output.',
        },
      },
      {
        id: 5,
        ...
        type: 'challenge',
        content: {
          challenge: 'Extend output to markdown format with a projects section and bullet highlights.',
          hint: 'Create a render_markdown(profile) function and map each experience/project to bullet lines.',
        },
      },
    ],
  },
