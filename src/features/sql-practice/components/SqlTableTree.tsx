            ...
            return (
              <li key={tbl.name}>
                <button
                  ...
                  className={cn(
                    'flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-left hover:bg-[#111827]',
                    wb.textPrimary,
                  )}
                >
                  ...
                  <span className={cn('ml-auto text-xs', wb.textMuted)}>{tbl.rowCount.toLocaleString()} rows</span>
                </button>
                {open && (
                  <ul className="ml-6 mt-0.5 space-y-0.5 border-l border-[#26324A] pl-3">
                    {tbl.columns.map((col) => (
                      ...
                      >
                        <span className={cn('font-mono', wb.textSecondary)}>{col.name}</span>
