  ...
  return (
    <aside className="flex h-full flex-col border-l border-slate-800 bg-slate-950">
      ...
      <div className="flex-1 overflow-y-auto p-3 text-xs text-slate-300 space-y-3">
        <p className="font-medium text-slate-200">List employee names</p>
        ...
        <div className="rounded border border-slate-800 bg-slate-900/60 p-2.5 text-[10px] text-slate-500">
